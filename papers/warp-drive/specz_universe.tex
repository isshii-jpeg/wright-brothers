...
Chamseddine and Connes~\cite{ChamseddineConnes1997} introduced the
spectral action principle; Chamseddine, Connes, and
Marcolli~\cite{CCM2007} derive the full SM
...
Schumayer and Hutchinson~\cite{Schumayer2011} comprehensively
reviewed connections between the Riemann hypothesis and
quantum physics, including random matrix theory and quantum chaos.
Manin~\cite{Manin1989} articulated an early vision of
``arithmetical physics'' connecting number theory to quantum fields.
...
\bibitem{Schumayer2011} D.~Schumayer and D.~A.~W.~Hutchinson, ``Colloquium: Physics of the Riemann hypothesis,'' Rev. Mod. Phys. \textbf{83}, 307 (2011).
\bibitem{Manin1989} Yu.~I.~Manin, ``Reflections on arithmetical physics,'' in \emph{Conformal Invariance and String Theory}, Academic Press (1989).
\bibitem{ChamseddineConnes1997} A.~H.~Chamseddine and A.~Connes, ``The spectral action principle,'' Commun. Math. Phys. \textbf{186}, 731 (1997).
\end{thebibliography}
