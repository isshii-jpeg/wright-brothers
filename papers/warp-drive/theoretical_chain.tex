...
\begin{enumerate}
  \item Both $F$ and $\mathcal{A}_{\mathrm{BC}}$ are
  ...
  \item The spectral action on $M^4 \times F$ produces
    $\zeta$-function values~\cite{CCM2007}, and the BC
    partition function \emph{is} the $\zeta$ function.
  \item Connes-Marcolli~\cite{ConnesMarcolli2006} explicitly
