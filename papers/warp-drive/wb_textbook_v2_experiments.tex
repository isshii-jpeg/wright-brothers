...
各実験は MA 理論の異なる「層」を検証する。ある実験が失敗しても、
...
\medskip
\textbf{MA公理との関係}：3公理とは\textbf{独立}。Berry位相 $\pi$ の存在は
...
\medskip
\textbf{MA公理との関係}：スペクトル作用原理（仮説H3）の検証。
...
\medskip
\textbf{MA公理との関係}：仮説H3（スペクトル重力）+ 仮説H4（Berry $\to$ 重力）の
...
\medskip
\textbf{MA公理との関係}：\textbf{公理3}（民主主義原理）の検証。
...
MA理論は「$\Omega_\Lambda$ はちょうど $2\pi/9$」と予測しており、
