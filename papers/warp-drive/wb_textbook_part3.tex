...
\newtcbtheorem[number within=section]{keytheorem}{主要定理}{
  colback=red!5!white,
...
\newtcbtheorem[number within=section]{keyresult}{主要結果}{
...
\newtcbtheorem[number within=section]{keylesson}{教訓}{
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small WB教科書 --- Part IV--VI \& 付録}
\fancyhead[R]{\small Wright Brothers Research Program}
\fancyfoot[C]{\thepage}

\begin{document}

\title{\Huge\bfseries Wright Brothers 教科書\\[0.5em]
\Large Part IV: ワープドライブ理論\\
Part V: 失敗と教訓\\
Part VI: 参加案内\\
付録}
\author{Wright Brothers Research Program\\
\texttt{https://github.com/isshii-jpeg/wright-brothers}}
\date{2026年4月}
